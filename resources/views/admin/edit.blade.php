    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <br/>
                <div class="card-body">
                    <form method="POST" action="{{ url('admin/update-transaction',[$transaction->id]) }}">
                        @csrf
                        @method('PUT')
                        ...
                        @foreach($transaction->payments as $payment)
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="actual_paid_date" type="date" class="form-control @error('actualPaidDate') is-invalid @enderror" value="{{ $payment->actual_paid_date }}" name="actualPaidDate[]" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="actual-paid-amount" value="{{ $payment->actual_paid_amount }}" type="number" class="form-control" name="actualPaidAmount[]"   autocomplete="actualPaidAmount">
